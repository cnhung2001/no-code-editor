...
<style>
    .tree-leaf {
        ...
        padding-left: calc(42px + var(--level) * 16px + 24px);
        display: flex;
        align-items: center;
    ...
    .tree-leaf_can-have-childs {
        padding-left: calc(36px + var(--level) * 16px + 24px + 6px);
    }
    ...
    .tree-leaf__menu:hover {
        opacity: 1 !important;
        background-color: var(--fill-transparent-2);
    }

    .tree-leaf__menu:active {
