...
import type { CardLocale, DeleteTranslationEntry, EditorInstance, EditorOptions, FileDialogShowProps, FileLimits, FontFaceDesc, GetTranslationKey, GetTranslationSuggest, ImageConversion, UpdateTranslationEntry } from '../../lib';
...
export interface AppContext {
    ...
    updateTranslationEntry: UpdateTranslationEntry | undefined;
    deleteTranslationEntry: DeleteTranslationEntry | undefined;
    refreshTranslations: (() => Promise<void>) | undefined;
