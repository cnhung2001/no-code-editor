<script lang="ts">
    ...
    import type { CardLocale, DeleteTranslationEntry, EditorInstance, EditorOptions, FileDialogApi, FileLimits, FontFaceDesc, GetTranslationKey, GetTranslationSuggest, ImageConversion, Layout, UpdateTranslationEntry } from './lib';
    ...
    import type { LeftBarTab } from './lib/components/leftBarTypes';
    ...
    export let updateTranslationEntry: UpdateTranslationEntry | undefined = undefined;

    export let deleteTranslationEntry: DeleteTranslationEntry | undefined = undefined;

    export let refreshTranslations: (() => Promise<void>) | undefined = undefined;
    ...
    let activeTab: LeftBarTab = 'components';
